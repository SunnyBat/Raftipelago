...
namespace Archipelago.MultiClient.Net
{
    public class ArchipelagoSession
    {
        ...
        {
            if (e.Type == Opcode.Text && PacketReceived != null) // NOTE: First part is hacked from e.IsText as IsText doesn't exist
            {
        ...
        private void OnError(object sender, ErrorEventArgs e)
        {
            ...
            {
                ErrorReceived(new Exception(e.Message), e.Message); // NOTE: Hacked from e.Exception as it doesn't exist
            }
        }
